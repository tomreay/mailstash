...
import { EmailAccountSettingsClient, AutoDeleteMode } from '@/lib/types/account-settings'
...
export function useSettingsManager({ 
  ...
  const handleDisableAutoDelete = useCallback(async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to disable auto-delete')
    } finally {
      setIsDryRunLoading(false)
    }
