...
export function SyncStatus(props: Props) {
    const syncStatus = useMemo(() => {
        switch (props.syncStatus) {
            ...
            default: return {
                text: props.lastSyncAt ? `Last sync: ${new Date(props.lastSyncAt).toLocaleString()}` : 'Never synced',
    ...
    return (
        <div className={`flex items-center justify-between px-3 py-2 rounded-lg ${syncStatus.classes}`}>
