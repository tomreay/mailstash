...
const PRESET_FREQUENCIES = [
  {
    value: 'manual',
    label: 'Manual only',
    description: 'No automatic syncing',
  },
  {
    value: '*/15 * * * *',
  ...
  },
  {
    value: '0 * * * *',
    label: 'Every hour',
    description: 'At the start of each hour',
  },
  {
    value: '0 */2 * * *',
    label: 'Every 2 hours',
    description: '12 times per day',
  },
  {
    value: '0 */6 * * *',
    label: 'Every 6 hours',
  ...
  },
  {
    ...
    description: 'Once per day at 00:00',
  },
  {
    value: '0 2 * * *',
    label: 'Daily at 2 AM',
    description: 'Once per day at 02:00',
  },
  {
    value: '0 0 * * 1',
...
export function SyncFrequencySelector({
  ...
  useEffect(() => {
    const isPreset = PRESET_FREQUENCIES.some(
      preset => preset.value === frequency
    );
