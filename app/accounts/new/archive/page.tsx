        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4">
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                value={archiveEmail}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setArchiveEmail(e.target.value)}
                disabled={loading}
              />
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setArchiveDisplayName(e.target.value)}
                disabled={loading}
              />
            </div>
          </div>
          ...
          <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
            <p className="text-sm text-amber-800">
              <strong>Note:</strong> Archive accounts are for one-time import only. 
              They won&apos;t sync with any email server. The import process may take 
