          ...
          <div className='grid gap-4'>
            ...
            <div className='grid gap-2'>
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setImapConfig({ ...imapConfig, displayName: e.target.value })
                }
                disabled={loading}
              />
            </div>
                ...
                <div className='flex items-center space-x-2 pt-2'>
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) =>
                      setImapConfig({ ...imapConfig, secure: checked })
                    }
                    disabled={loading}
                  />
            ...
            <div className='grid gap-2'>
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setImapConfig({ ...imapConfig, user: e.target.value })
                }
                disabled={loading}
              />
            </div>
            ...
            <div className='grid gap-2'>
              ...
              <Input
                ...
                onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                  setImapConfig({ ...imapConfig, pass: e.target.value })
                }
                disabled={loading}
              />
            </div>
